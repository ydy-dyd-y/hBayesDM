...
data {
  ...
  real<lower=-100,upper=0> outcome[N,T];
}
...
transformed parameters {
  ...
  vector<lower=-100,upper=0>[N] theta;
  vector<lower=0,upper=1>[N] beta;
  vector<lower=-100,upper=0>[N] mu0;
...
generated quantities {
  ...
  real<lower=-100,upper=0> mu_theta;
  real<lower=0,upper=1> mu_beta;
  real<lower=-100,upper=0> mu_mu0;
